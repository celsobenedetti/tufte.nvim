...
function M.get(c, opts)
  ...
  return {
    ...
    Visual                      = { bg = c.highlight, fg = c.highlight_fg },
    VisualNOS                   = { bg = c.highlight, fg = c.highlight_fg },
    WarningMsg                  = { fg = c.warning, bold = true },
    Whitespace                  = { fg = c.muted },
    WildMenu                    = { bg = c.highlight },
    ...
    LspSignatureActiveParameter = { bg = Util.blend_bg(c.highlight, 0.4), bold = true },
